                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        ...
                                        <?php }elseif ($type=='Canvas'){ ?>
                                            <button class="btn btn-outline btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="Appraisal" onclick="show_appraisal_canvas('<?php echo $kode_grade; ?>','<?php echo $id_pelajaran; ?>','<?php echo $id_week; ?>','<?php echo $minggu; ?>','<?php echo $id_interactive; ?>','<?php echo $name_interactive; ?>','<?php echo $state_interactive; ?>','<?php echo $type; ?>','<?php echo $key->id;?>','<?php echo $key->idResponse;?>','<?php echo $key->username;?>')"><i class="fa fa-stack-exchange"></i></button>
                                        <?php } ?>
                                    </center>
                                </td>
                            </tr>
